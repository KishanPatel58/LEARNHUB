const videos = [
    ...
    { title: "Stack", src: "../static/videoes/frontendhtml.mp4", completed: false },
    { title: "Queue", src: "../static/videoes/frontendcss.mp4", completed: false },
    { title: "Double Ended", src: "../static/videoes/frontendcss.mp4", completed: false },
    { title: "Linkedlist", src: "../static/videoes/frontendjs.mp4", completed: false },
    { title: "Singli Linkedlist", src: "../static/videoes/frontendjs.mp4", completed: false },
    { title: "Doublie Linkedlist", src: "../static/videoes/frontendjs.mp4", completed: false },
    { title: "Binary Tree", src: "../static/videoes/frontendjs.mp4", completed: false },
    { title: "Binary Search Tree", src: "../static/videoes/frontendjs.mp4", completed: false },
];
